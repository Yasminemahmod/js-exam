...
window.addEventListener('load', function(){
  ...
  document.getElementById("byFirstLetter").value = ""
})
...
let byFLetter = document.getElementById("byFirstLetter")
let dishes = document.querySelectorAll(".dishes .row")
var dishName;
...
function searchByName(value) {
  if(value == "") {
    dishes.innerHTML = ""
      ...
      // =========== Home Page ===========
  let dishesCard = document.querySelector(".dishes .row")
